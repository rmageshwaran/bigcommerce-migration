...
public class ProductComponentsMigrationPipeline : IProductComponentsMigrationPipeline
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var allComponents = ExtractAllComponentsFromProducts(productsWithComponents, migrationId);
    ...
    /// </summary>
    private Dictionary<string, List<ComponentWithContext>> ExtractAllComponentsFromProducts(
