...
// Integration tests are not orchestrator functions and should use ConfigureAwait(false) for better performance
// Test projects can suppress these code analysis warnings as they are not production code
[assembly: SuppressMessage("Reliability", "CA2007:Consider calling ConfigureAwait on the awaited task", Justification = "Integration tests should use ConfigureAwait(false) for better performance")]
